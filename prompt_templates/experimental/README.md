...
### Example-based with custom rubric 
[Link](./example_custom_rubric.py)<br/>
Same as previous but also defining a metric-specific meaning for each 1-5 score.

## Incident-based 
[Link](./incident_based.py)<br/>
...
### Key indicators with incidents 
[Link](./indicators_incidents.py)<br/>
