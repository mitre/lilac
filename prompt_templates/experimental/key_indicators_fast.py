...
Consider ONLY the problem indicators provided. Do not make up additional indicators.
Overall score: [choose 1-5]
Justification: A bulleted list for each key indicator that was strongly detected, where each list item is a one-sentence explanation not more than ten words. Do not include the name of the key indicator in the list item.
"""
