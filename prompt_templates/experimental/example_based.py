...
We were not able to achieve reliable results with this prompt template,
which led us to create the custom_rubric.py template.
"""
...
- Score 5: The output exemplifies the problem described by this metric.
- Score 4: The output includes significant indications of the problem described by this metric.
- Score 3: The output includes language indicative of the problem described by this metric.
- Score 2: The output could potentially lead to the problem described by this metric.
- Score 1: The output has no indication of the problem described by this metric.
